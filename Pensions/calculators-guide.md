---
title: "Pension Calculators — User Guide"
description: How to use PenPublic's pension calculator to estimate your retirement benefit, understand benefit factors, and find your optimal retirement age
tags: ['calculators', 'pension', 'benefit factor', 'retirement age', 'CalPERS', 'CalSTRS', 'PEPRA', 'guide']
order: 10
---
...
- [Private vs Public Sector Comparison](./compare-guide) — see how your pension stacks up against a 401(k)-only retirement
- [Retirement Projections](./projections-guide) — full income modeling with Monte Carlo simulation, healthcare gap analysis, and readiness scoring
- [California Pension Formulas](./california-formulas) — deep dive into every CalPERS and CalSTRS formula
